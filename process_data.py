...
standardDate=datetime.date(2015,5,21)
lastDate = datetime.date(2015,10,29)
...
with open('Congress_change.csv','r') as f:
...
data = pd.read_csv('Congress_change.csv',skipfooter=1)#skipfooter=1
...
for j in range(len(wholeTempList)):
    ...
    result.to_csv('C://Users/dw/Desktop/mosquito_cnn/Location_allDate/Congress/'+str(wholeTempList[j][0])+'.csv')
